...
BEGIN
  ...
  "external_id", "context", "version", "created_at", "created_by", "updated_at", "updated_by")
  VALUES
  ...
  NEW."external_id", NEW."context", NEW."version", NEW."created_at", NEW."created_by", NEW."updated_at", NEW."updated_by");
